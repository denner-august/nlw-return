    ...
    <>
      ...
      <div className="flex flex-col items-center py-10 w-[304px]">
        ...
        <button
          ...
          type="button"
          className="py-2 px-6 mt-6 bg-zinc-800 rounded-[4px] border-transparent text-sm leading-6 hover:bg-zinc-700 transition-colors focus:border-brand-500 focus:outline-none focus:ring-offset-brand-500 focus:ring-1 "
        >
          Quero enviar outro
        </button>
      </div>
